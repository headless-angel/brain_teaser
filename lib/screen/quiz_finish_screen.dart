...
import 'package:brain_teaser/screen/show_question_screen.dart';
import 'package:brain_teaser/util/constant.dart';
import 'package:brain_teaser/widget/button.dart';
...
class QuizFinishPage extends StatefulWidget {
  ...
  const QuizFinishPage(
      {Key? key, required this.title, this.answer, this.listQuestion})
      : super(key: key);
